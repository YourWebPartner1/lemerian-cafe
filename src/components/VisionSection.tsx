  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto relative z-10 text-center">
        ...
        {/* 🖼️ Floating Visuals (Equal size, perfectly aligned) */}
        <div className="relative h-[400px] mb-24 flex justify-center items-center gap-20 flex-wrap md:flex-nowrap">
          {/* 🇮🇳 India */}
          <motion.div
          ...
          >
            <motion.img
              src={visionIndia}
              alt="India"
              className="w-60 h-60 md:w-64 md:h-64 object-cover rounded-3xl shadow-xl drop-shadow-[0_0_50px_rgba(255,138,0,0.6)]"
            />
          </motion.div>
          ...
          >
            <img
              src={cafehero}
              alt="Cafe Hero"
              className="w-60 h-60 md:w-64 md:h-64 object-cover rounded-3xl shadow-2xl drop-shadow-[0_0_80px_rgba(255,94,142,0.6)]"
            />
          ...
          >
            <motion.img
              src={visionLaptop}
              alt="Laptop"
              className="w-60 h-60 md:w-64 md:h-64 object-cover rounded-3xl shadow-xl drop-shadow-[0_0_60px_rgba(72,102,201,0.6)]"
            />
          </motion.div>
        </div>
