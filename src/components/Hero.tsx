...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* Floating Lights */}
      <motion.div
        className="absolute top-24 right-10 w-24 h-24 bg-gradient-to-br from-[#f44545] to-[#FFD700] rounded-full blur-3xl opacity-50"
        animate={{ y: [0, -15, 0], opacity: [0.4, 0.7, 0.4] }}
        transition={{ duration: 6, repeat: Infinity, ease: "easeInOut" }}
      />
      <motion.div
        className="absolute bottom-40 left-20 w-32 h-32 bg-gradient-to-br from-[#265999] to-[#f44545] rounded-full blur-3xl opacity-40"
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
        ...
        <motion.p
          ...
          className="text-lg md:text-xl text-gray-100 mb-12 max-w-2xl mx-auto leading-relaxed"
      ...
      >
        <div className="w-8 h-14 border-2 border-white/60 rounded-full flex items-start justify-center p-2 backdrop-blur-sm bg-white/5">
      ...
      <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-none rotate-180 pointer-events-none">
        <svg
          ...
          className="w-full h-[120px] fill-[#fff]"
        >
...
const Feature: React.FC<FeatureProps> = ({ icon, text }) => (
  <motion.div
    ...
    className="flex items-center gap-2 bg-white/10 backdrop-blur-md px-4 py-2 rounded-full border border-white/20 hover:border-white/40 shadow-[0_0_15px_rgba(255,255,255,0.15)] transition-all"
  >
    {icon}
