...
export default function Contact() {
  ...
  return (
    <section
      id="contact"
      className="relative pt-16 max-[375px]:pt-12 sm:pt-24 pb-0 overflow-hidden bg-gradient-to-b from-white via-[#f9fbff] to-[#e9f0ff]"
    >
      {/* Background Glow */}
      <motion.div
      ...
      <motion.div
        className="absolute w-20 sm:w-32 h-20 sm:h-32 bg-gradient-to-br from-[#f44545]/20 to-[#265999]/20 rounded-full blur-2xl top-10 left-4 sm:left-20"
        animate={{ y: [0, -20, 0], x: [0, 10, 0] }}
        transition={{ duration: 8, repeat: Infinity, ease: "easeInOut" }}
      />
      <motion.div
        className="absolute w-16 sm:w-24 h-16 sm:h-24 bg-gradient-to-br from-[#265999]/20 to-[#f44545]/20 rounded-full blur-2xl bottom-10 right-4 sm:right-20"
      ...
      <AnimatePresence>
        {showToast && (
          <motion.div
            ...
            className="fixed bottom-4 sm:bottom-8 right-4 sm:right-8 bg-gradient-to-r from-[#265999] to-[#f44545] text-white px-4 sm:px-6 py-3 sm:py-4 rounded-xl sm:rounded-2xl shadow-xl flex items-center gap-2 sm:gap-3 z-50 text-xs sm:text-base"
          >
      ...
      <div className="max-w-7xl mx-auto px-4 max-[375px]:px-3 sm:px-6 md:px-10 relative z-10">
        {/* Header */}
        <div className="text-center mb-10 sm:mb-16">
          <h2 className="text-[clamp(1.8rem,5vw,3rem)] font-bold mb-3 sm:mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 mb-12 sm:mb-16">
          ...
          <motion.form
            ...
            className="space-y-5 sm:space-y-6 bg-white p-5 sm:p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all"
          ...
          >
            ...
            <motion.button
              ...
              type="submit"
              className="w-full py-3 sm:py-4 text-sm sm:text-lg font-semibold text-white rounded-xl shadow-lg bg-gradient-to-r from-[#f44545] via-[#f96c6c] to-[#265999] bg-[length:200%_200%] transition-all"
            >
              Send Message
            </motion.button>
          </motion.form>
          ...
          <div className="space-y-8">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6 }}
              className="bg-white p-5 sm:p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all"
            >
              <h3 className="text-lg sm:text-2xl font-bold text-gray-800 mb-5 sm:mb-6">
                Contact Information
              </h3>
                    ...
                    <div>
                      ...
                      {linkLabel && (
                        <a
                          href={link}
                          target="_blank"
                          className="block mt-2 text-[#265999] hover:text-[#f44545] font-medium transition-colors text-xs sm:text-sm"
                        >
                          {linkLabel}
                        </a>
                      )}
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6 }}
              className="bg-gradient-to-r from-[#f44545] to-[#265999] p-5 sm:p-8 rounded-2xl shadow-lg text-white"
            >
              <h3 className="text-lg sm:text-2xl font-bold mb-3 sm:mb-4">Follow Us</h3>
              <p className="mb-5 sm:mb-6 opacity-90 text-xs sm:text-base">
              ...
              <div className="flex space-x-3 sm:space-x-6">
                <motion.a
                  ...
                  className="w-9 sm:w-12 h-9 sm:h-12 bg-white/20 rounded-xl flex items-center justify-center hover:bg-white/30"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 24 24" className="w-5 sm:w-7 h-5 sm:h-7">
      ...
      <footer className="bg-[#f5f8ff] border-t border-gray-200 shadow-inner">
        ...
        />
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-10 py-6 flex flex-col md:flex-row items-center justify-between gap-3 sm:gap-4 text-xs sm:text-base">
          <div className="flex items-center space-x-3">
            <div className="bg-gradient-to-r from-[#f44545] to-[#265999] p-2 rounded-full shadow-md">
              <Coffee className="w-4 sm:w-6 h-4 sm:h-6 text-white" />
            </div>
      ...
      >
        <div className="relative w-12 sm:w-16 h-12 sm:h-16 bg-gradient-to-br from-[#25D366] via-[#20b358] to-[#128C7E] rounded-full shadow-lg flex items-center justify-center hover:scale-110 transition-transform duration-300">
          ...
          <svg
            ...
            fill="white"
            viewBox="0 0 24 24"
            className="w-5 sm:w-8 h-5 sm:h-8 relative z-10"
          >
